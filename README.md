...
![Time Series Soothing using different Centred Moving Averages]()
...
![Detrended Time Series with the Seasonal Profile]()
...
![Seasonal Naive Forecasting Model and Average Index with Average Level Forecasting Model]()
...
![Seasonal Exponential Smoothing Forecasting Model]()
...
![In-sample and Out-of-sample Error Comparison across different models]()
...
![In-sample Error Comparison and Out-of-sample Error Comparison for Seasonal Naive, Average Index with Average Level and Seasonal Smoothing Forecasting Models]()
...
![Day-wise Inventory Levels and Cost Breakdowns for EOQ-based Inventory System (ROQ=13 units)]()
...
![Cost Breakdowns Comparison (left) and Ideal ROP for both ROQs (right)]()
...
![Updated Objective Function Equation]()
...
![Wait Times and Mechanic-wise Idle Time Comparison]()
...
![Gantt Chart based on the simulation output]()
